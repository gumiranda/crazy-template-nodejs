...
export const envSchema = z.object({
  ...
  googleMapsKey: z.string().optional().default("your_key"),
  kafkaUsername: z.string().optional().default("your_key"),
  kafkaPassword: z.string().optional().default("your_key"),
  kafkaHost: z.string().optional().default("your_key"),
  kafkaClientId: z.string().optional().default("your_key"),
  pagarmeKeySecret: z.string().optional().default("your_key"),
  pagarmeKeyPublic: z.string().optional().default("your_key"),
  wooviKey: z.string().optional().default("your_key"),
  wooviWebhookKey: z.string().optional().default("your_key"),
  stripeKey: z.string().optional().default("your_key"),
  stripeKeySecret: z.string().optional().default("your_key"),
  database: z.enum(["postgres", "mongodb"]).default("mongodb"),
  FUSORARIOBR: z.string(),
  PGUSER: z.string().optional().default("your_key"),
  PGPASSWORD: z.string().optional().default("your_key"),
  PGHOST: z.string().optional().default("your_key"),
  PGDATABASE: z.string().optional().default("your_key"),
  PGPORT: z.string().optional().default("your_key"),
});
